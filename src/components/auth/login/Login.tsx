            ...
            >
                ...
                <div className='flex flex-col gap-4 items-center w-full'>
                    ...
                    <div className='w-full max-md:flex-col flex mt-[20px] gap-4 md:pl-4'>
                        <CommonButton type='button' href='/auth/register' className='min-w-1/2 max-md:w-full bg-secondary justify-center' title=' ساخت حساب کاربری ' icon={<ChevronLeft size={20} />} />
